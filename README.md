...
- [Config](wiki/Config)
  - [Advanced config](wiki/Config#advanced-config)
    - [Automatically remove devices](wiki/Config#automatically-remove-devices)
- [Supported routers](wiki/Supported-routers)
  - [Check list](wiki/Supported-routers#check-list)
    - [Required](wiki/Supported-routers#required)
    - [Additional](wiki/Supported-routers#additional)
    - [Action](wiki/Supported-routers#action)
  - [Summary](wiki/Supported-routers#summary)
- [Conflicts](wiki/Conflicts)
- [Entities](wiki/Entities)
- [Services](wiki/Services)
  - [Calculate passwd](wiki/Services#calculate-passwd)
  - [Send request](wiki/Services#send-request)
- [Events](wiki/Events)
  - [Luci response](wiki/Events#luci-response)
- [Performance table](wiki/Performance-table)
- [Example automation](wiki/Example-automation)
  - [Device blocking](wiki/Example-automation#device-blocking)
