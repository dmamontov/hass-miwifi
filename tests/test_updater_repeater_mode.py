...
async def test_updater_repeater_mode(
    ...
    assert updater.data[ATTR_SENSOR_AP_SIGNAL] == 27
    ...
    assert updater.data[ATTR_SENSOR_MODE] == Mode.REPEATER
...
async def test_updater_repeater_mode_force_load(
    ...
    assert len(mock_luci_client.mock_calls) == 29


@pytest.mark.asyncio
async def test_updater_repeater_mode_move(hass: HomeAssistant) -> None:
    """Test updater.
...
@pytest.mark.asyncio
async def test_updater_repeater_mode_revert_move_force_mode(
    hass: HomeAssistant,
) -> None:
    """Test updater.
...
@pytest.mark.asyncio
async def test_updater_repeater_mode_move_force_mode(hass: HomeAssistant) -> None:
    """Test updater.
...
@pytest.mark.asyncio
async def test_updater_repeater_mode_restore(hass: HomeAssistant) -> None:
    """Test updater.
...
@pytest.mark.asyncio
async def test_updater_repeater_mode_restore_force_mode(hass: HomeAssistant) -> None:
    """Test updater.
